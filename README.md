...
Впоследствии, если вы будете придерживаться единообразия в написании кода, у вас будет легко расширяемое приложение
...
Следующий шаг — применение миграций БД (`python manage.py migrate`). По умолчанию в качестве
базы данных проект использует SQLite, которого должно быть достаточно для начала разработки.
